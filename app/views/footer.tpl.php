      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($allTypeForFooter as $type) : 
                ...
                ?>
              <li> 
                <a href="<?= $altoRouter->generate('catalog-type', ['idType'=>$type->getId()])?>" class="text-muted">
                  <?= $type->getName() ?>
                </a>
              </li>
              <?php endforeach; ?>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php 
              //var_dump($allBrandForFooter);
              foreach ($allBrandForFooter as $brand) : 
              //var_dump($brand);
              /*  sans altoRouter qui génère le lien
              <li> <a href="<?= $absoluteURL ?>/catalogue/marque/<?= $brand->getId() ?>" class="text-muted"><?= $brand->getName() ?></a></li> */
              ?>
                <li> <a href="<?= $altoRouter->generate('catalog-brand', ['idBrand'=>$brand->getId()])?>" class="text-muted"><?= $brand->getName() ?></a></li>
              <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-3 text-center text-md-left">
            <p class="mb-md-0">Tous droits réservés<br>© <?= date('Y') ?> oShop</p>
          </div>
          <div class="col-md-6 text-center">
            <p class="mb-md-0"><a class="text-white" href="<?= $absoluteURL ?>/mentions-legales">Mentions légales</a><br><a class="text-white" href="#">Conditions générales de vente</a></p>
          </div>
